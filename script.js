...
// Stores the city in local storage
...
// formating the date, beacuse it's needed
...
// function to retrieve to information
    ...
    .then(function(weatherResponse) {
        ...
        if (weatherResponse.cod != "200") {
            ...
            return;
                ...
                // sending the list array for the data about the forescast
